...
def createCommandParser():
    ...
    parser_bmcdump.add_argument("-t", "--dumpType", required=True, choices=['bmc','SystemDump'],help="Type of dump")
    ...
    parser_dumpretrieve.add_argument("-n,", "--dumpNum", help="The Dump entry to delete")
