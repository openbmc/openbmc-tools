...
def certificateUpdate(host, args, session):
    """
         Called by certificate management function. update certificate
    ...
    httpHeader = {'Content-Type':'application/octet-stream'}
    url="https://"+host+"/xyz/openbmc_project/certs/"+args.type+"/"+args.service
    data=open(args.fileloc,'rb').read()
...
def createCommandParser():
    ...
    certUpdate.add_argument('type', help="certificate type to update")
    ...
    certDelete.add_argument('type', help="certificate type to delete")
    certDelete.add_argument('service', help="Service to detelet the certificate")
