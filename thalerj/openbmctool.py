...
def certificateGenerateCSR(host, args, session):
    """
        ...
        client certificates
        Example:
        certificate generatecsr server w3.ibm.com IBM US IBM IBM-UNIT NJ EC 2048 prime256v1 cp email ibm.com,abc.com gn sn in ClientAuthentication,ServerAuthentication
        certificate generatecsr server w3.ibm.com IBM US IBM IBM-UNIT NJ RSA 2048 None cp email ibm.com,abc.com gn sn in ClientAuthentication,ServerAuthentication
        certificate generatecsr server w3.ibm.com IBM US IBM IBM-UNIT NJ EC 0 prime256v1 cp email ibm.com,abc.com gn sn in ClientAuthentication,ServerAuthentication
        certificate generatecsr client w3.ibm.com IBM US IBM IBM-UNIT NJ RSA 2048 None cp email ibm.com,abc.com gn sn in ClientAuthentication,ServerAuthentication
        @param host: string, the hostname or IP address of the bmc
    ...
    try:
        ...
        data ={"CertificateCollection":{"@odata.id":url},
            ...
            "Email":args.email, "GivenName":args.givenname, "Initials":args.initials,  "KeyUsage":usage_list,
            "Surname":args.surname, "UnstructuredName":args.unstructuredname}
