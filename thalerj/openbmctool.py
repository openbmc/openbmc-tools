...
def createCommandParser():
    ...
    parser_thermMode = therm_subparser.add_parser("mode", help="Set thermal control modes")
    parser_thermMode.add_argument('-z', '--zone', help='Thermal zone to work with')
    parser_thermMode.add_argument('-m', '--mode', choices=['custom'], help='The thermal control mode')
    parser_thermMode.add_argument('-s', '--state', choices=['on','off'], help="The values for thermal control mode command")
    parser_thermMode.set_defaults(func=setThermalMode)
