...
def certificateGenerateCSR(host, args, session):
    """
         ...
         client certificates
         Example:
         certificate generatecsr server w3.ibm.com IBM US IBM IBM-UNIT NJ RSA "2048" prime256v1
         certificate generatecsr client w3.ibm.com IBM US IBM IBM-UNIT NJ RSA "2048" prime256v1
         certificate generateCSR server NY IBM USA IBM IBM-UNIT NJ RSA 1024
         certificate generateCSR client NY IBM USA IBM IBM-UNIT NJ EC 1024 prime256v1
         certificate generateCSR client NY IBM USA IBM IBM-UNIT NJ RSA 1024
         @param host: string, the hostname or IP address of the bmc
...
def createCommandParser():
    ...
    certGenerateCSR.add_argument('keyPairAlgorithm',  choices=['RSA', 'EC'],
        help="he type of key pair for use with signing algorithms.")
