...
def createVLAN(host, args, session):
    """
         Called by the ldap function. Creates VLAN on given interface.
...
def viewDHCPConfig(host, args, session):
    """
         Called by the ldap function. Shows DHCP configured Properties.
...
def configureDHCP(host, args, session):
    """
         Called by the ldap function. Configures/updates DHCP Properties.
...
def nwReset(host, args, session):
    ...
    """
        Called by the network function. Resets network settings to factory reset.
...
def createCommandParser():
    ...
    parser_setdomainname.add_argument("-D", "--DomainName", required=True,
                                      help="A DomainName for the Interface")
    ...
    # rmIP
    parser_rmIP = nw_sub.add_parser("rmIP", help="prints out IP address"
                                     "of given interface")
    ...
    # configure VLAN
    parser_create_vlan = nw_sub.add_parser("enableVLAN", help="enables VLAN "
    ...
    parser_create_vlan.set_defaults(func=createVLAN)

    # delete VLAN
    parser_delete_vlan = nw_sub.add_parser("disableVLAN", help="disables VLAN "
                                           "on given interface with given "
                                           "VLAN Identifier")
    ...
    parser_nw_reset = nw_sub.add_parser("factoryReset",
                                        help="Resets network settings to "
                                        "factory reset")
