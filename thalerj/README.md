...
To upload the CA certificate on the BMC: refer to the section "Update LDAP root certificate"
...
To enable root user: refer to the section "To re-enable all local user accounts"
